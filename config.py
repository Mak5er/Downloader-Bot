...
DOWNLOAD_QUEUE_PER_USER_PENDING_TIMEOUT_SECONDS = (
    _read_float_env("DOWNLOAD_QUEUE_PER_USER_PENDING_TIMEOUT_SECONDS") or 0.0
)
...
BATCH_LINKS_MAX_CONCURRENCY = _read_int_env("BATCH_LINKS_MAX_CONCURRENCY") or 2
BATCH_LINKS_PARALLEL_QUEUE_DEPTH_THRESHOLD = _read_int_env("BATCH_LINKS_PARALLEL_QUEUE_DEPTH_THRESHOLD") or 2
BATCH_LINKS_PARALLEL_ACTIVE_JOBS_THRESHOLD = _read_int_env("BATCH_LINKS_PARALLEL_ACTIVE_JOBS_THRESHOLD") or 3
